...
; -----------------------------
Name "${APPNAME} 1.4.1"
OutFile "release\OriginPXRD_Installer_v1.4.1.exe"

VIProductVersion "1.4.1.0"
VIFileVersion    "1.4.1.0"
...
VIAddVersionKey "OriginalFilename"   "OriginPXRD_Installer_v1.4.1.exe"
...
Section "Install"
    ...
    StrCpy $TempDir "$TEMP\OriginPXRD_1.4.1"
